...
<h1 class="f2 mb0"><span class="red">Quick</span>note</h1>
<p class="f5 mt1 mb4 lh-copy">A quick way to write and store your notes online</p>
<form action="/note" method="POST" enctype="multipart/form-data">
    <ol class="list pl0">
        ...
        <li class="mv3"><label class="f6 b db mb2" for="textContent">Write your content here</label>
            <textarea class="f4 db border-box hover-black w-100 measure ba b--black-20 pa2 br2 mb2" rows="5"
                      name="textContent"><#if textContent??>${textContent}</#if></textarea>
